  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-[60%]  flex flex-col gap-y-16 lg:flex-row justify-between items-center pb-[60px] lg:pb-[80px]">
        <div
          className={`${!theme.theme ? "text-black" : "text-white"
        ...
        >
          ...
          <div className={`${!theme.theme ? "border-black" : "border-white"
        ...
        <div className=" lg:order-2 order-2 flex flex-col justify-between gap-4">
          <p className={`${!theme.theme ? "text-black" : "text-white bg-transparent"
        ...
        >
          ...
          <p ref={scroll} className={`${!theme.theme ? "text-black" : "text-white bg-transparent"
