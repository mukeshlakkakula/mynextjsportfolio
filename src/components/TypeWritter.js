  ...
  return (
    <div className="flex flex-col gap-3 lg:gap-6 justify-between">
      ...
      >
        ...
        and user-centric solutions. I have successfully led website
        redevelopment projects and implemented advanced features like
        Server-Side Rendering (SSR), secure authentication using JWT, and
        real-time updates.
      </p>
      <div className="flex gap-3">
        ...
        <a
          ...
          className={`${
            !newTheme ? "text-black" : "text-white"
          } font-medium flex items-center gap-1 text-base lg:text-lg font-bold border-2 rounded-full pl-6 pr-6 pt-1 pb-1 hover:bg-red-500  hover:text-white`}
        >
          Resume <FaDownload />
        </a>
      </div>
